...
def flow_normalized_w1(gt, pred):
	gt = list(gt.values())
	pred = list(pred.values())
	return w1(pred, gt) / w1([0 for _ in range(len(gt))], gt)
...
for host_num in [16, 64, 128]:
	...
	print("Per flow normalized avgRTT W1")
	print(flow_normalized_w1(gt_flow_avgRTT, pred_flow_avgRTT))


	print("Per flow normalized p99RTT W1")
	print(flow_normalized_w1(gt_flow_p99RTT, pred_flow_p99RTT))
	...
	print("Per flow normalized avgJitter W1")
	print(flow_normalized_w1(gt_flow_avgjitter, pred_flow_avgjitter))


	print("Per flow normalized p99Jitter W1")
	print(flow_normalized_w1(gt_flow_p99jitter, pred_flow_p99jitter))
